...
const Home = () => {
  const stats = [
    ...
    { icon: Award, label: 'Qualified Teachers', value: '100+' },
    { icon: Clock, label: 'Classes Completed', value: '100,000+' },
  ];
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-700 sm:text-xl">
              One-on-one live Quran classes for kids and adults. Expert teachers, flexible schedules, and personalized learning from the comfort of your home.
            </p>
